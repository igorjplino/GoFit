...
public class CreateWorkoutTrackingCommandTests
{
    private readonly CreateWorkoutTrackingCommandValidator _validator;

    private readonly MockRepository _mockRepository;
    private readonly Mock<IWorkoutRepository> _workoutRepositoryMock;

    public CreateWorkoutTrackingCommandTests()
    {
        _mockRepository = new MockRepository(MockBehavior.Loose);

        _workoutRepositoryMock = _mockRepository.Create<IWorkoutRepository>();

        _validator = new CreateWorkoutTrackingCommandValidator(_workoutRepositoryMock.Object);
    }
    ...
    {
        var command = new CreateWorkoutTrackingCommand
        {
            Note = "ab"
        };
