...
public class DeleteWorkoutEndpoint :
    BaseEndpoint<DeleteWorkoutCommand, Guid?>
{
    private readonly UserManager<AppUser> _userManager;

    public DeleteWorkoutEndpoint(
        ILogger<DeleteWorkoutEndpoint> logger,
    ...
    public override async Task HandleAsync(DeleteWorkoutCommand req, CancellationToken ct)
    {
