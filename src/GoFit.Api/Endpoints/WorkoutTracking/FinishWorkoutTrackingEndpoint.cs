...
public class FinishWorkoutTrackingEndpoint :
    BaseEndpoint<FinishWorkoutTrackingCommand, Guid>
{
    private readonly UserManager<AppUser> _userManager;

    public FinishWorkoutTrackingEndpoint(
        ILogger<FinishWorkoutTrackingEndpoint> logger,
    ...
    {
        Put("WorkoutTracking/{WorkoutsTrackingId}/finish");
        Permissions(AppPermissions.Training.EditWorkoutTracking);
    }

    public override async Task HandleAsync(FinishWorkoutTrackingCommand req, CancellationToken ct)
    {
