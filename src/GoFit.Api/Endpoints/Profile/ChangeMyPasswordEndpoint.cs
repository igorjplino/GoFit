...
public class ChangeMyPasswordEndpoint :
    BaseEndpoint<ChangeMyPasswordCommand, bool>
{
    private readonly UserManager<AppUser> _userManager;

    public ChangeMyPasswordEndpoint(
        ILogger<ChangeMyPasswordEndpoint> logger,
    ...
    public override async Task HandleAsync(ChangeMyPasswordCommand req, CancellationToken ct)
    {
        ...
        Result<bool> result = await Mediator.Send(req, ct);
